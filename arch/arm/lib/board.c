...
volatile long *ptr = (void*)0x41f01000;
__attribute__((always_inline)) static inline void debug_now(void)
{
    long pc;
...
__attribute__((always_inline)) static inline void debug_p1(long p)
{
    long pc;
    asm volatile ("mov %0, pc" : "=r" (pc));
    *(ptr++) = pc;
